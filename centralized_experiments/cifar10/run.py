...
def main():
    ...
    train_data = torchvision.datasets.CIFAR10('../../../CIFAR10/', train=True, transform=transform_train)
    trainloader = torch.utils.data.DataLoader(train_data,
                                              batch_size=args.batch_size,
                                              shuffle=True,
                                              num_workers=6)
    test_data = torchvision.datasets.CIFAR10('../../../CIFAR10/', train=False, transform=transform_test)
