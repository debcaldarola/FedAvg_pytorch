...
class MyCIFAR10(Dataset):
    def __init__(self, main_dir, file_dir, transform):
    ...
    def __getitem__(self, idx):
        img_loc = os.path.join(self.main_dir, self.dataset['x'][idx])
...
def main():
    ...
    train_data = MyCIFAR10(main_dir='../../data/cifar10/data/raw/img/train/', file_dir='../../data/cifar10/data/train/', transform=transform_train)
    trainloader = torch.utils.data.DataLoader(train_data,
                                              batch_size=args.batch_size,
                                              shuffle=True,
                                              num_workers=1)
    test_data = MyCIFAR10(main_dir='../../data/cifar10/data/raw/img/test/', file_dir='../../data/cifar10/data/test/', transform=transform_test)
